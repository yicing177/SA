...
public class Submeal extends MenuItem {
	...
	public Submeal(String type, String itemID, String name, int price, String description, String sauce,
			String ingredient) {
	...
	private static List<MenuItem> subMealMenu = new ArrayList<>();
	...
	public static List<MenuItem> getSubMealMenu() {
		return new ArrayList<>(subMealMenu); 
	}
}
